        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
           ...
           <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            <div className='flex flex-col'>
                <h1 className='text-3xl md:text-4xl font-playfair'> Experience Tour Like Never Before</h1>
           ...
           bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] rounded-xl p-6 mx-auto mt-16 max-w-6xl'>
           ...
           <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>
                The guest will be welcomed with no noise pollution, fresh air and raw nature. You will get local foods to taste. We guarantee You will get a vibe of raw Bangladesh.
            </p>
           </div>
        {/* Hosted by */}
