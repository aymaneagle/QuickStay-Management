...
const MyBookings = () => {
  ...
  const [bookings, setBookings] = useState(userBookingsDummyData);
    ...
    return (
        <div className="py-28 px-4 md:pb-35 md:pt-32 md:px-16 
        lg:px-24 xl:px-32" >
            <Title title= "My Bookings" 
            subTitle="Easily manage your past, current and upcoming 
            stay reservations in one place. Plan your trips seamlessly
                ...
                <div className="flex flex-col items-start justify-center pt-3">
                    <div className="flex items-center gap-2">
                     ...
                     {!booking.isPaid && (
                        ...
                        rounded-full hover:bg-green-50 transition-all cursor-pointer ">
                            Pay now
                        </button>
                     ) }
