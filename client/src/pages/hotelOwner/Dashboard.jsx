...
const Dashboard = () => {
    ...
    return (
        <div>
            <Title font="outfit" align="left" title="Dashboard" subTitle="Monitor your 
            stay listings, track bookings and analyze revenue-all in one place. Stay 
            updated with real-time insights to ensure smooth operations." />

            <div className="flex gap-4 my-8">
                {/*--------Total Bookings------*/}
                <div className="bg-primary/3 border border-primary/10 rounded-2xl
                flex p-4 pr-8 ">
