...
const ListRoom = () => {
    return (
        <div>
            <Title title="Stay Listings" 
            subTitle="View, edit, or manage all listed staying. Keep the information up-to-date to provide the best experience for users."
            align="left"
            font="outfit"
            />
            <p className="text-gray-500 mt-8 ">All Places</p>
                        ...
                        roomsDummyData.map((item, index) =>(
                            <tr key={index} >
                                ...
                                <td
                                 ...
                                 <td
                                 className="py-3 px-4 text-red-500 border-t border-gray-300 text-center">
                                    <label className="relative inline-flex items-center cursor-pointer
                                    text-gray-900 gap-3">
                                        <input type="checkbox" className="sr-peer peer" 
